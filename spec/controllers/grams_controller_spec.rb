...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "should return a 404 message if we cannot find a gram with the id that was specified" do
  ...
  describe "grams#update action" do
    it "should allow users to successfully upate grams" do
  ...
  describe "grams#create action" do
    ...
    it "should successfully save a new gram in our database" do
      user = FactoryGirl.create(:user)
      sign_in user
